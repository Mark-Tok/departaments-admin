...
class Departaments extends React.Component {
  ...
  addDataState(data) {
    if(data.departaments === 'developers') {
      ...
      data.index = index;
      this.setState({
        developers: this.state.developers.concat(data)
      })
    }
    if(data.departaments === 'designers') {
      ...
      data.index = index;
      this.setState({
        designers: this.state.designers.concat(data)
      })
    }
    if(data.departaments === 'accounting') {
      ...
      data.index = index;
      this.setState({
        accounting: this.state.accounting.concat(data)
      })
    }
    if(data.departaments === 'sale') {
      ...
      data.index = index;
      this.setState({
        sale: this.state.sale.concat(data)
      })
    }
    if(data.departaments === 'marketing') {
      ...
      data.index = index;
      this.setState({
        marketing: this.state.marketing.concat(data)
      })
    }
    if(data.departaments === 'headhunter') {
      ...
      data.index = index;
      this.setState({
        headhunter: this.state.headhunter.concat(data)
      })
    }
    if(data.departaments === 'support') {
      ...
      data.index = index;
      this.setState({
        support: this.state.support.concat(data)
      })
    }
    if(data.departaments === 'management') {
      ...
      data.index = index;
      this.setState({
        management: this.state.management.concat(data)
      })    
    }
  }
  ...
  <div className="App">
    ...
    <div className="dev">
      <p>Отдел разработки</p>
        <Userinfo departament='developers' info={this.state.developers} delete={this.deleteItemState}/>
    </div>
    <div className="designer">
      <p>Отдел дизайна</p>
        <Userinfo departament='designers' info={this.state.designers} delete={this.deleteItemState}/>
    </div>
    <div className="sale">
      <p>Отдел продаж</p>
        <Userinfo departament='sale' info={this.state.sale} delete={this.deleteItemState}/> 
    </div>
    <div className="support">
      <p>Техническая поддержка</p>
        <Userinfo departament='support' info={this.state.support} delete={this.deleteItemState}/>
    </div>
    <div className="headhunter">
      <p>Отдел кадров</p>
        <Userinfo departament='headhunter' info={this.state.headhunter} delete={this.deleteItemState}/>
    </div>
    <div className="accounting">
      <p>Отдел бухгалтерии</p>
        <Userinfo departament='accounting' info={this.state.accounting} delete={this.deleteItemState}/>
    </div>
    <div className="marketing">
      <p>Отдел маркетинга</p>
        <Userinfo departament='marketing' info={this.state.marketing} delete={this.deleteItemState}/>
    </div>
    <div className="management">
      <p>Отдел управления</p>
        <Userinfo departament='management' info={this.state.management} delete={this.deleteItemState}/>
    </div>
  </div>);
  }
}
